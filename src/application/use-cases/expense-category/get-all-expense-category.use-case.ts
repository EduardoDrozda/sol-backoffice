...
export class GetAllExpenseCategoryUseCase
  implements IBaseUseCase<GetPaginationBaseDto, BaseResponseWithPaginationDto<GetExpenseCategoryResponseDto>> {
  constructor(
    @Inject(EXPENSE_CATEGORY_REPOSITORY) private readonly expenseCategoryRepository: IExpenseCategoryRepository,
  ...
  async execute(data: GetPaginationBaseDto) {
    ...
    return PaginationHelper
      .paginate<GetExpenseCategoryResponseDto>(categories, page, limit!);
  }
}